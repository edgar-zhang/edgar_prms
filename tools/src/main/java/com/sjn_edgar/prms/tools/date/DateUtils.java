 ...
 * @ClassName: DateUtils
 * @Title   日期、时间工具类
 * @Description: <p> 处理日期与时间相关操作 </p>
 * @author zhangbo
 * @email zbo@51qmz.cn
 * @version V1.0
 * @date 2016-8-15 16:12:00
 */
public class DateUtils {
	 ...
	 * @Description: 将中文字符串格式的日期转换成时间格式
	 * @param zh_date
	 * @throws ParseException   
	 * @return: Date   
	 */
	public static Date getSimpleDateFormat(String zh_date){
		
		SimpleDateFormat simpleDateFormat = null;
		Date date = null;

		//1.判断字符串第五位是否是以"."	字符串格式：2012.08.23
		if (zh_date.startsWith(".", 4)) {
			simpleDateFormat = new SimpleDateFormat("yyyy.MM.dd");
		}
		//2.判断字符串第五位是否是以"/" 字符串格式 ： 2014/2/2 17:02:12
		if (zh_date.startsWith("/", 4)) {
			simpleDateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
		}
		//3 判断字符串第五位是否是以"-" 字符串格式 ： 2014-2-2 
		if (zh_date.startsWith("-", 4)) {
			simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		}
		
		try {
			date = simpleDateFormat.parse(zh_date);
	...
	/**
	 * @Title: getCurrentTimeFileName
	 * @Description: 获取以当期日期命名的文件名
	 * @return   如：20160815
	 * String
	 */
	...
	/**
	 * @Title: 计算当前日期 + 天数
	 * @Description: 判断当前时间与设置的23点相比较，
	 *                  如果在之前，加 1 ；
	 *                  如果在之后，加 2.
	 * @return   
	 * String
	 */
	public static String getDate_Add(){
		//判断 11 点 之前提交还是之后提交 
	 ...
	 * @param date 日期
	 * @param dateStyle 日期风格  --- 通过枚举设置日期格式
	 * @return 日期字符串
	 */
    ...
    /**
     * @Title: getGMTTime
     * @Description: 获取格林尼治标准时间 --- 历元（epoch）”，即 1970 年 1 月 1 日 00:00:00 GMT
     * @return   
     * Date
     */
