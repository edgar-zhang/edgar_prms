package com.sjn_edgar.prms.home.web.controller.login;

import com.sjn_edgar.prms.common.dwz.DWZ;
import com.sjn_edgar.prms.common.dwz.DwzAjax;
import com.sjn_edgar.prms.domain.permission.PmsOperator;
import com.sjn_edgar.prms.home.exception.PermissionException;
import com.sjn_edgar.prms.home.web.controller.common.BaseController;
import com.sjn_edgar.prms.service.permission.PmsMenuService;
import com.sjn_edgar.prms.service.permission.PmsOperatorRoleService;
 ...
 * @Description:  <p> 登陆管理 </p>
 * @author         edgar【zbo@51qmz.cn】		   
 * @version        V 1.0  
 * @Date           2016/8/15 17:36 
 */
@Controller
